...
public class WhisperUiTableComponent {

    private static final String VIEW_ID = "sampleTable";
    private static final String VIEW_TEXT = "Whisper Controllers";
    ...
    private final UiMessageHandlerFactory messageHandlerFactory =
            () -> ImmutableList.of(
                    new WhisperUiTableMessageHandler(controller)
            );
    ...
    protected void activate() {
        ...
        log.info("Started Whisper controllers stats");
    }

    @Deactivate
    protected void deactivate() {
        uiExtensionService.unregister(extension);
        log.info("Stopped Whisper controllers stats");
    }

...
public class WhisperUiComponent {

    private static final String VIEW_ID = "sampleCustom";
    private static final String VIEW_TEXT = "6TiSCH Schedule";
    ...
    private final UiMessageHandlerFactory messageHandlerFactory =
            () -> ImmutableList.of(
                    new WhisperUiMessageHandler(controller)
            );
            
            
            
    public void update(){
            	log.info("Updating WHISPER UI COMP.");
            }        
    ...
    protected void activate() {
        ...
        log.info("Started 6TiSCH schedule");
    }

    @Deactivate
    protected void deactivate() {
        uiExtensionService.unregister(extension);
        log.info("Stopped 6TiSCH schedule");
    }
